...
<body>
    <div class="container">
        ...
        <div class="details">
            ...
            <p><strong>Payment:</strong> ₱<?php echo number_format($row['payment'], 2); ?></p>
        ...
        <div class="action-buttons">
            ...
            <?php if($can_edit): ?>
                <a href="ps_edit.php?id=<?php echo $id; ?>" class="btn btn-primary">Edit Case</a>
                <a href="ps_payment.php?id=<?php echo $id; ?>" class="btn btn-primary">Record Payment</a>
            <?php else: ?>
                <span class="btn btn-disabled">Edit (View Only)</span>
                <span class="btn btn-disabled">Record Payment (View Only)</span>
            <?php endif; ?>
        </div>
    </div>
</body>
